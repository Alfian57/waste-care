        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-gray-600 font-['CircularStd'] truncate text-sm">
                {user.email || 'No email'}
              </p>
              {/* EXP Badge - Compact */}
              <div className="flex items-center space-x-1 mt-2">
                ...
                <span className="text-sm font-semibold text-gray-900 font-['CircularStd']">
                  {loadingExp ? '...' : userExp.toLocaleString()}
                </span>
                <span className="text-xs text-gray-500 font-['CircularStd']">EXP</span>
              </div>
            </div>
          </div>
        </div>
